...
<html>
	...
	<body>
		...
		<div id="show-entity" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:entityInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${entityInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

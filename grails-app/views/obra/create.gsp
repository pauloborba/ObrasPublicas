...
<html>
	...
	<body>
		<a href="#create-obra" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-obra" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:obraInstance, action:'save']" >
				<fieldset class="form">
